...
var _ReactCSSTransitionReplaceChild = _interopRequireDefault(require("./ReactCSSTransitionReplaceChild"));
...
var reactCSSTransitionReplaceChild = _react.default.createElement.bind(null, _ReactCSSTransitionReplaceChild.default);
...
var ReactCSSTransitionReplace = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactCSSTransitionReplace(props) {
    ...
    _this.state = {
      currentKey: '1',
      currentChild: _this.props.children ? _react.default.Children.only(_this.props.children) : undefined,
      prevChildren: {},
      height: null,
      width: null
    };
  ...
  _createClass(ReactCSSTransitionReplace, [{
    ...
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      var nextChild = nextProps.children ? _react.default.Children.only(nextProps.children) : undefined;
    ...
    value: function enqueueHeightTransition() {
      if (!this.rafHandle) {
        this.rafHandle = (0, _requestAnimationFrame.default)(this.performHeightTransition);
      }
    }
  }, {
    key: "wrapChild",
    ...
    value: function render() {
      ...
      Object.keys(prevChildren).forEach(function (key) {
        ...
        childrenToRender.push( /*#__PURE__*/_react.default.createElement(childComponent, {
          key: key,
          style: positionAbsolute
        }, _this2.wrapChild(notifyLeaving && typeof child.type !== 'string' ? /*#__PURE__*/_react.default.cloneElement(child, {
          isLeaving: true
        }) : child, {
          ref: function ref(r) {
      ...
      return /*#__PURE__*/_react.default.createElement(component, containerProps, childrenToRender);
    }
  }]);
...
_defineProperty(ReactCSSTransitionReplace, "propTypes", {
  ...
  changeWidth: _propTypes.default.bool,
  notifyLeaving: _propTypes.default.bool
});
